    ...
    <main>
        <div class="tse-content-wrapper position-relative">
            <div class="container-fluid page-banner"
                style="background: linear-gradient(135deg, #0f5132 0%, #03153b 100%); border-bottom: 1px solid #ffffff1a;">
                <div class="container text-center text-white">
                    <h1 class="display-4 fw-bold">Refund Policy</h1>
                    <p class="lead text-light-muted">Transparent and fair transactions.</p>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="section-card m-0 h-100">
                                    <span class="consistency-head"><i
                                            class="bi bi-hourglass-split me-2"></i>Eligibility</span>
                                    <ul class="tse-list">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="section-card m-0 h-100">
                                    <span class="consistency-head"><i class="bi bi-check-circle me-2"></i>Grounds for
                                        Refund</span>
                                    <ul class="tse-list">
                        ...
                        <div class="section-card">
                            ...
                            <p class="mb-3">Email our support at <b class="text-info">info@tseedu.com</b> with order
                                details.</p>
                            <div class="p-3 rounded"
                                style="background: rgba(13, 202, 240, 0.1); border: 1px solid rgba(13, 202, 240, 0.2);">
                                <ul class="mb-0 list-unstyled">
                                    <li><i class="bi bi-arrow-right-short text-info"></i> Reimbursed via original
                                        payment method.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <ul class="tse-list">
                                <li>Cancellation requests must be made within <b class="text-white">3 days</b> from
                                    purchase.</li>
                            </ul>
                        </div>

                        <div class="contact-box mt-4">
                            <h5 class="fw-bold text-white"><i class="bi bi-headset me-2"></i>Refund Support</h5>
