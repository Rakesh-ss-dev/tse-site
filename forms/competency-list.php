                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div
                                ...
                                <h6 class="text-white text-capitalize ps-3">Competency List</h6>
                                <a href="competency_form.php" class="btn btn-primary">Create Competency</a>
                            </div>
                        </div>
                                        ...
                                        while ($row = $res->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $category="SELECT * FROM `compentecy_category` WHERE `category_id`='".$row['category']."'"; 
                                                ...
                                                <td class="align-middle">
                                                    <a href="competency_form.php?id=<?php echo $row['id'] ?>"
