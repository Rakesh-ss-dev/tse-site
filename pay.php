...
<head>
    ...
    <style>
        ...
        .summary-box hr { border-color: rgba(255, 255, 255, 0.2); }
...
<div class="container checkout-container">
    <div class="card">
        <div class="card-body p-4 p-md-5">
            ...
            <form action="pay_process.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" name="phone" class="form-control" placeholder="10-digit mobile number" pattern="[0-9]{10}" title="Please enter a valid 10 digit mobile number" required>
                </div>

                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-phonepe btn-lg d-flex justify-content-center align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-phone-vibrate me-2" viewBox="0 0 16 16">
                          ...
                          <path d="M11.5 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-5zM2 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-5z"/>
                        </svg>
        ...
        <div class="card-footer text-center text-light-muted small py-3">
