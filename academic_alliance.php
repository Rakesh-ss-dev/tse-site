        ...
        <section class="home-banner competency-banner">
            ...
            <div class="container d-flex align-items-center h-100">
                <div class="banner-content">
                    <h1 class="text-white">TSE and Skill Sigma - Together<br class="d-none d-md-block"> shaping talent
                        from classrooms <br class="d-none d-md-block"> to boardrooms
                    </h1>
                </div>
            </div>
        </section>
                ...
                <div class="row gap-3 gap-md-0">
                    <div class="col-md-6 ms-auto">
                        ...
                        <p class="text-white">Skill Sigma is not just a training vertical - it's a mission. A mission to
                            ...
                            world.</p>
                        <p class="text-white">While universities shape the academic foundation, Skill Sigma steps in to
                            fine-tune those capabilities with industry-grade training, making students project-ready,
                            job-ready, and future-ready.</p>
                    </div>
        ...
        <section class="my-75">
            <div class="container">
                ...
                <h5 class="text-white text-center mt-4">
                    ...
                    programs that create a <br class="d-none d-md-block"> seamless bridge from academics to careers.
                </h5>
            </div>
        </section>
        <section class="my-75">
            <div class="container">
                <h3 class="text-light-blue text-center mb-4">How We Stay Ahead</h3>
                <div class="row align-items-stretch">
                    ...
                    <div class="col-md-6 my-auto">
                        ...
                        <div class="card p-5  tse-tabs-section">
                            ...
                            <p class="text-white">Skill Sigma isn't CSR. <br> It's strategic, meaningful, and impactful
                                - a way for us at TSE to build India's future workforce with intention and excellence.
                            </p>
                            <p class="text-white mb-0">We call it an Academic Alliance.You'll call it a game-changer.
                            </p>
                        </div>
                    </div>
                </div>
