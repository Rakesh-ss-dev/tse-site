        ...
        <div class="row">
          <div class="col-md-8 mx-auto">
            ...
            <p class="text-white">For the past 15 years, we have been at the forefront of enterprise training,
              ...
              network of 2000+ expert trainers, we have helped organizations stay ahead in a rapidly evolving tech
              landscape, ensuring their workforce is equipped with the latest industry skills. As technology advances,
              so do we—continuously evolving to meet the ever-changing demands of businesses across industries."</p>
          </div>
        </div>
      </div>
    </section>
    <div class="container-fluid py-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 my-30">
            <a class="text-decoration-none" href="competency.php?id=21">
              <div class="competency-box">
                <h5>Testing & QA</h5>
