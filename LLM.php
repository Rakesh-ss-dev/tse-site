...
<body class="bg-dark-blue">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-black2">
        <div class="container">
    ...
    <section class="py-5 bg-black2">
        <div class="row m-0">
            <div class="col-11 mx-auto col-md-12">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 mx-auto">
                            <img src="images/llm2.jpg" width="100%" alt="">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex flex-column">
                            <div class="position-relative">
                                ...
                                <h3 class="text-white text-absolute">Large Language Model</h3>
                            </div>
                            <p class="text-white">Building a Large Language Model (LLM) from scratch is no longer just
                                for tech giants - it's a skill within your reach! Imagine creating your own AI, training
                                it on vast datasets, and fine-tuning it for specific tasks. This course simplifies the
                                complex world of LLMs, breaking down each step into practical, hands-on learning - no
                                overwhelming jargon, just real-world applications.
                            </p>
                            <p class="text-white">AI is evolving fast, and companies are investing heavily in custom
                                language models to
                                gain a competitive edge. Will you be part of this revolution or get left behind? Now is
                                the time to master LLM development and future-proof your career! Join this course and
                                start building AI from the ground up - because the future isn't waiting! </p>
                        </div>
                        <div class="col-md-6 ms-auto">
                            <div class="prerequisites">
                                <h3 class="text-light-blue mb-4">Prerequisites</h3>
                                <div class="preq-div">
                                    <p class="text-white">Basic understanding of programming concepts</p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Familiarity with the Python programming language</p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Prior experience in machine learning is beneficial but not
                                        mandatory</p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Access to a laptop or computer with internet connectivity</p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Willingness to install required Python packages and libraries
                                    </p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Curiosity and interest in learning about large language models
                                        and AI</p>
                                </div>
                                <div class="preq-div">
                                    <p class="text-white">Completion of the course <strong>"Generative AI and Prompt
    ...
    <section id="CreateTheFutureOfAI" class="my-5">
        <div class="row m-0">
            <div class="col-11 mx-auto col-md-12">
                <div class="container bg-white-opace p-3">
                    <div class="row">
                        ...
                        <div class="col-md-5 my-auto">
                            <h2 class="text-white">Create the Future of AI</h2>
                            <p class="text-white">The power of AI lies in its ability to understand, generate, and
                                evolve - and it all
                                starts with Large Language Models (LLMs). From training datasets to fine-tuning
                                architectures, building an LLM from scratch is no longer just for research labs. It's
                                the key to unlocking AI-driven innovations across industries. Whether you're a
                                developer, researcher, or AI enthusiast, mastering LLMs puts you at the forefront of the
                                AI revolution. At The Skill Enhancers (TSE), we'll guide you step by step, turning
                                complex AI concepts into hands-on learning. Ready to build the future? Let's get
                                started!</p>
                        </div>
                    </div>
                </div>
